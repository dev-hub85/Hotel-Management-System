...
import myimg4 from '../Assets/a1.jpg';
import myimg5 from '../Assets/a2.jpg';
import myimg6 from '../Assets/a3.jpg';
import myimg7 from '../Assets/a4.jpg';
import myimg8 from '../Assets/a5.jpg';
import myimg9 from '../Assets/a6.jpg';
...
const Attraction = () => {
  ...
  <div className="containerpara">
    <p id='intropara' style={{fontWeight : 'bold' , fontSize: '25px'}}>Attraction</p>
  </div>
  <div>
  <section id="gallery1" className="gallery1">
      <div className="container1">
        <div className="gallery-details1">
          <div className="gallery-box1">
            <div className="gallery-content1">
              <div className="filtr-container1">
                <div className="row">
                  <div className="col-md-6">
                    <div className="filtr-item1">
                      <img src={myimg4} alt="portfolioimage" />
                      <div className="item-title1">
                        <a href="#">Lahore Fort</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6">
                    <div className="filtr-item1">
                      <img src={myimg5} alt="portfolio image" />
                      <div className="item-title1">
                        <a href="#">Minar-e-Pakistan</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-md-4">
                    <div className="filtr-item1">
                      <img src={myimg6} alt="portfolio image" />
                      <div className="item-title1">
                        <a href="#">Fortress</a>
                      </div>
                    </div>
                  ...
                  <div className="col-md-4">
                    <div className="filtr-item1">
                      <img src={myimg7} alt="portfolio image" />
                      <div className="item-title1">
                        <a href="#">Tomb of Jahangir</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-md-4">
                    <div className="filtr-item1">
                      <img src={myimg8} alt="portfolio image" />
                      <div className="item-title1">
                        <a href="#">Shalimar Gardens</a>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-8">
                    <div className="filtr-item1">
                      <img src={myimg9} alt="portfolio image" />
                      <div className="item-title1">
                        <a href="#">Safari Park Lahore</a>
                      </div>
                    </div>
                  </div>
                </div>
